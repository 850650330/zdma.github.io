    ...
    render() {
        ...
        return (
            <div className="App animated bounceInLeft">
                ...
                <div id="autotype">
                    <h1 style={{ fontWeight: 900 }}>亲爱的婷婷：</h1>
                    <p>这是我们在一起的第7年，从2016年3月19日到现在，我们一起经历了许许多多的事情，
                    这一路有欢笑也有争吵，有陪伴也有分离，但是我们都走过来了。</p>
                    <p>如果两个人的经历可以写成一本书，那我们的故事一定是个传奇，谁都复制不了，没错，这是仅属于我们的故事
                        我经常想，在一起7年，但还是感觉是刚认识你的时候，仿佛一回头，看见的是在大学操场散步的我们，是冬天一起打水的我们
                        也是11点后宿舍内外的我们
